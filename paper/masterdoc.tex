...
\begin{document}
    ...
    \section{System Analysis}
        ...
        \subsection{SCBENCH} 
            ...
            For reading the test was executed for sequential and random access of the data. However the test for sequential read access weren't sufficient enough to evaluate, therefore I will only show the results for random read, which is more important in the context of database operations anyway.
            ...
            \paragraph{Write performance}
                ...
                period where no data is written has an overall bigger impact on the measurement. As the client is writing data to the OSDs, the writespeed increases.
                ...
                The write IOPS in figure \ref*{fig:write-iops} exhibits the same result: Initial IOPS start slow due to the cost of initializing, subsequently increasing
                as the initialization has a smaller impact on the results but with saturation decreasing again.
