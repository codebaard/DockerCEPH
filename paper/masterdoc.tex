...
\begin{document}
    ...
    \section{Setting up CEPH on Docker}
        ...
        \subsection{CEPH Architecture}
            ...
            % mention about data striping, placement groupts and crush map
            ...
            % theres probably some important stuff about PG Groups and Crush maps

            \subsubsection{Metadata Service}

            %mention some details here about putting the MDS on an nVME SSD
            % important for FS access

            \subsubsection{Manager}    

            % what does the manager even do?
            % got mandatory in some release
