...
\begin{document}
    ...
    \section{Setting up CEPH on Docker}
        ...
        \subsection{System Architecture}\label{system:my-setup}
            ...
            \subsubsection{Docker Config for CEPH Image}
                ...
                driver which is provided by the docker image. This allows every container which has this driver enabled to appear as a seperate host apart from the docker host.
                This is configured with the \textit{--ip=192.167.178.2XX} option.
            ...
            % ##keyring issue
            % https://github.com/ceph/ceph-container/issues/1683
    ...
    \section{System Analysis}
        ...
        % why this is important for databases (strippedn down version of mySQL section)
        ...
        \subsection{Raw performance test}
