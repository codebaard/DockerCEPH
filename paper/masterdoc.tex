...
\begin{document}
    ...
    \section{Introduction}
        ...
        \subsection{Problem domains}\label{introduction}
            ...
            As for CEPH, this is especially true, since there are three major versions in production\cite{ceph releases}, as of early 2021.
        ...
        \subsection{Related Work}
            ...
            run a SQL-Database on a CEPH-Cluster\cite{redhat}. They concluded that indeed running a database on an 
            ...
            has therefore only very little relevance to the topic of this paper. Although there are numerous papers
