...
\begin{document}
    ...
    \section{System Analysis}
        ...
        \section{Mysqlslap}
            ...
            % single core process
            % concurrent users is multiple of corecount
            % did some testing to figure out best user/query combination to avoid reference system bottlenecks
            % resulsting script: ...
            % tested on: system reference nVME SSD, Docker host SSD, Docker host HDD, CEPH Cluster

            %problem: mysql docker does not work well with ceph cluster - normal mysql server did 
