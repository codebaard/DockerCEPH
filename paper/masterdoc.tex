...
\begin{document}
    ...
    \section{Introduction}
        ...
        \textit{containerization} as its colloquially called. This way of deploying applications and services decreased the complexity of deploying several services and application on any given host dramatically by providing each service with an isolated runtime environment with the necessary dependencies
    ...
    \section{Setting up CEPH on Docker}
        ...
        \subsubsection{Containerization}\label{system:containerization}
            ...
            launched in little time with no effort. However in the domain of application development or microservices especially with CI/CD\footnote{Continuous Integration/Continuous Deployment} pipelines in mind, this is an u necessary overhead.
            Containers on the other hand are small entities, which contain only the  necessary components of an application or service to run and still have some degree of encapsulation to the host system.
        ...
        \subsection{CEPH Architecture}\label{ceph:arch}
            ...
            CEPH these are called daemons, which are discussed in detail in the following sections.
            ...
            \subsubsection{Metadata Server - MDS}
                ...
                The metadata server is not  necessary for the cluster to operate as RBD, storage bucket or via Librados API.
        ...
        \subsection{System Architecture}\label{system:my-setup}
            ...
            Firstly, because of the Covid-19 pandemic I couldn't use the lab in the university so I had to rely on my personal resources 
    ...
    \section{System Analysis}
        ...
        \subsection{SCBENCH} 
            ...
            \paragraph{Read performance}
                ...
                The read speed starts at around 1700MB/s, which is multiple times more than the other more saturated tests were able to achieve. 
