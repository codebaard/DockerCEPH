...
\begin{document}
    ...
    \section{Setting up CEPH on Docker}
        ...
        \subsection{System Architecture}\label{system:my-setup}
            ...
            \subsubsection{Creating the cluster}
                ...
                \textit{ceph\_mon1}) from the host shell. These three commands create the data pools and the filesystem, which requires as metadata pool and a data pool\textbf{ADD CEPH DOC HERE}.
    ...
    \section{System Analysis}
        ...
        \section{Mysqlslap}\label{mysqlslap}
            ...
            \textbf{INSERT CEPH TEST HERE ONCE READY!!!}
            % make remark of switching off some OSDs
